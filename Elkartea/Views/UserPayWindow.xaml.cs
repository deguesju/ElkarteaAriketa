...
namespace TPV_Gastronomico.Views
{
    public partial class UserPayWindow : UserControl
    {
        ...
        public UserPayWindow()
        {
            ...
            // Saiatzen gara datu-baseko produktuak kargatzen; fallback gisa adibideak erabiltzen dira.
            try
            {
                using var db = new AppDbContext();
                AllProducts = db.Products?.Select(p => new Product { Name = p.Nombre, Price = Convert.ToDecimal(p.Precio) }).ToList()
                    ?? new List<Product>();
            }
            catch
            {
                // DB akats ezagun batean, erabilera errazteko adibide produktuak
        ...
        private void lbResults_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            {
                ErrorHelper.HandleException(ex, "Produktua gehitzean errorea (ordainketa leihoa)");
            }
        }
        ...
        private void UpdateTotal()
        {
            ...
            {
                ErrorHelper.HandleException(ex, "Totala kalkulatzean errorea");
            }
        }
        ...
        private void Remove_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ErrorHelper.HandleException(ex, "Produktua ezabatzean errorea (ordainketa leihoa)");
            }
        }
        ...
        private void Pay_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ErrorHelper.HandleException(ex, "Ordainketa prozesuan errorea");
            }
        }
